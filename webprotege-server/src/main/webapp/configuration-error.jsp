...
<html>
<head>
    <title>AxiomatIQ Configuration Error</title>
</head>
<body style="font-family: arial,sans-serif; color: #464646; font-size: 14px;">
    <h1>AxiomatIQ Initialization Error</h1>
    <p>An error occurred during the initialization of AxiomatIQ which prevented AxiomatIQ from starting.
    </p>
    <h2>Error Message</h2>
