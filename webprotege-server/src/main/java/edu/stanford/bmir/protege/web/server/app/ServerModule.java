...
import edu.stanford.bmir.protege.web.server.project.Neo4jProjectComponentFactory;
...
public class ServerModule {
    ...
    @Provides
    public ProjectComponentFactory provideProjectComponentFactory(Neo4jProjectComponentFactory impl) {
        return impl;
    }
}
