 ...
 * 7 Jun 2018
 */
public class EntityAnnotationExistsMatcher implements EntityFrameMatcher {
    ...
    public EntityAnnotationExistsMatcher(@Nonnull HasAnnotationAssertionAxioms axiomProvider,
