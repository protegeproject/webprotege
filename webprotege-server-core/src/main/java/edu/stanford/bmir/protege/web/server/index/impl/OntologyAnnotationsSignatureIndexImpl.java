 ...
 * 2019-09-05
 */
public class OntologyAnnotationsSignatureIndexImpl implements OntologyAnnotationsSignatureIndex, RequiresOntologyChangeNotification {

    private Multimap<OWLOntologyID, OWLAnnotation> annotationsMap = ArrayListMultimap.create();

    @Inject
    public OntologyAnnotationsSignatureIndexImpl() {
    }
