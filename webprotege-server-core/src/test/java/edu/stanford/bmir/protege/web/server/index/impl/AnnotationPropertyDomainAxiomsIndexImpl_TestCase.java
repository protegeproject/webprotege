...
public class AnnotationPropertyDomainAxiomsIndexImpl_TestCase {
    ...
    public void setUp() {
        ...
        when(axiomsByTypeIndex.getAxiomsByType(AxiomType.ANNOTATION_PROPERTY_DOMAIN, ontologyDocumentId))
    ...
    public void shouldGetAnnotationPropertyDomainAxiomForProperty() {
        var axioms = impl.getAnnotationPropertyDomainAxioms(property, ontologyDocumentId).collect(toSet());
        assertThat(axioms, hasItem(axiom));
    }

    @Test
    public void shouldGetEmptySetForUnknownOntologyId() {
        var axioms = impl.getAnnotationPropertyDomainAxioms(property, mock(OntologyDocumentId.class)).collect(toSet());
        assertThat(axioms.isEmpty(), is(true));
    }

    @Test
    public void shouldGetEmptySetForUnknownClass() {
        var axioms = impl.getAnnotationPropertyDomainAxioms(mock(OWLAnnotationProperty.class), ontologyDocumentId).collect(toSet());
        assertThat(axioms.isEmpty(), is(true));
    }
    ...
    public void shouldThrowNpeForNullProperty() {
        impl.getAnnotationPropertyDomainAxioms(null, ontologyDocumentId);
    }
