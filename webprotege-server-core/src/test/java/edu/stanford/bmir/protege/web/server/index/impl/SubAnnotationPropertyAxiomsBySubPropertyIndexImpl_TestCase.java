...
import edu.stanford.bmir.protege.web.server.index.impl.SubAnnotationPropertyAxiomsBySubPropertyIndexImpl;
...
public class SubAnnotationPropertyAxiomsBySubPropertyIndexImpl_TestCase {
    ...
    public void setUp() {
        ...
        when(ontology.getSubAnnotationPropertyOfAxioms(property))
                .thenReturn(Collections.singleton(axiom));
        impl = new SubAnnotationPropertyAxiomsBySubPropertyIndexImpl(ontologyIndex);
    }
