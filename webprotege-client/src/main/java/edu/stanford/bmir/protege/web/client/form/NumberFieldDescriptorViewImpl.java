 ...
 * 2019-11-18
 */
public class NumberFieldDescriptorViewImpl extends Composite implements NumberFieldDescriptorView {

    private static final int DEFAULT_LENGTH = 10;

    interface NumberFieldDescriptorViewImplUiBinder extends UiBinder<HTMLPanel, NumberFieldDescriptorViewImpl> {
    ...
    @Inject
    public NumberFieldDescriptorViewImpl(@Nonnull LanguageMapEditor placeholderEditor) {
