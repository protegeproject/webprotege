 ...
 * 13 Jun 2018
 */
public class StringContainsRepeatedSpacesCriteriaPresenter implements CriteriaPresenter<LiteralComponentsCriteria> {
    ...
    @Override
    public Optional<LiteralComponentsCriteria> getCriteria() {
