 ...
 * 13 Jun 2018
 */
public class StringContainsRepeatedSpacesCriteriaPresenterFactory implements CriteriaPresenterFactory<LiteralComponentsCriteria> {
    ...
    @Nonnull
    @Override
    public CriteriaPresenter<LiteralComponentsCriteria> createPresenter() {
