...
public interface WebProtegeClientBundle extends ClientBundle {
    ...
    interface WebProtegeCss extends CssResource {
        ...
        @ClassName("wp-form__control")
        String formControl();

        @ClassName("wp-form__control__editor")
        String formControlEditor();

        @ClassName("wp-form__control__editor--text")
        String formControlEditorText();

        @ClassName("wp-form__control__editor--entity")
        String formControlEditorEntity();
