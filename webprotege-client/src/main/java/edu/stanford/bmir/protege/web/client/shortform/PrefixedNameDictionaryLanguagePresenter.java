 ...
 * 2020-08-10
 */
public class PrefixedNameDictionaryLanguagePresenter implements DictionaryLanguagePresenter {

    @Nonnull
    private final DictionaryLanguageBlankView view;

    @Inject
    public PrefixedNameDictionaryLanguagePresenter(@Nonnull DictionaryLanguageBlankView view) {
    ...
    public Optional<DictionaryLanguage> getDictionaryLanguage() {
        return Optional.of(PrefixedNameDictionaryLanguage.get());
    }
