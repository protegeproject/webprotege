 ...
 * Date: 17/08/2012
 * <p>
 *     Represents an identifier for a {@link Note}.  The identifier has a lexical form which uniquely determines it.
 * </p>
 * <p>
 *     ReplyId objects are immutable.
 * </p>
 */
public final class NoteId implements HasLexicalForm, Serializable {
    ...
    public static NoteId createNoteIdFromLexicalForm(String replyIdLexicalForm) {
        if(replyIdLexicalForm == null) {
            throw new NullPointerException("replyIdLexicalForm must not be null");
        }
        return new NoteId(replyIdLexicalForm);
    }

    @Override
    public int hashCode() {
        return NoteId.class.getSimpleName().hashCode() + lexicalForm.hashCode();
    }
