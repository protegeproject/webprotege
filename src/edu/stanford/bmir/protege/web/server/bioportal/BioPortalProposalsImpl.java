...
public class BioPortalProposalsImpl  extends WebProtegeRemoteServiceServlet implements BioportalProposals {
    ...
    public static void main(String[] args) {
        BioPortalProposalsImpl inst = new BioPortalProposalsImpl();
