 ...
 */
public class ManchesterSyntaxFrameEditorPortlet extends AbstractOWLEntityPortlet {

    private ManchesterSyntaxFrameEditorPresenter presenter;

    public ManchesterSyntaxFrameEditorPortlet(Project project) {
        super(project);
    }

    public ManchesterSyntaxFrameEditorPortlet(Project project, boolean initialize) {
