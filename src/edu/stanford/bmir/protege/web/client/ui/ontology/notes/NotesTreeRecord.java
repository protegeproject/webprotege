...
public class NotesTreeRecord {
    ...
    public NotesTreeRecord(NotesData record, Project projectName, EntityData currentEntity, NotesTreeRecord parent){
    ...
    private void fillRepliesPanel(FlexTable repliesPanel2, List<NotesData> notes){
        if(notes != null){
            ...
            for(NotesData reply : notes){
                NotesTreeRecord r = new NotesTreeRecord(reply, this.project, this.currentEntity, this);
    ...
    private void reply() {
        ...
        if(text != null && text.length() > 0) {
            text = "<br><br>===== " + this.record.getAuthor() + " wrote on " + this.record.getCreationDate()
            + ": ======<br>" + text;
        } else {
            text = "";
        }
        ...
        final NotesTreeRecord caller = this;
        NoteInputHandler nih = new NoteInputHandler(this.project, this.currentEntity, new AsyncCallback<NotesData>(){
    ...
    private void edit(){
        ...
        NoteInputHandler nih = new NoteInputHandler(this.project, this.currentEntity, new EditNoteHandler(this));
        nih.setRecord(record);
        nih.editNote();
    }
    ...
    public void addChildNote(NotesData child){
            ...
            NotesTreeRecord r = new NotesTreeRecord(child, project, currentEntity, this);
