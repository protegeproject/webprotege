...
//                    com.google.gwt.event.logical.shared.SelectionEvent.fire(OntologiesPortlet.this, ProjectId.get(projectName));
//
//                }
//            }
//        });
...
//        pm.getProjects(Application.get().getUserId(), new GetProjectsHandler());
//    }
//
//    @Override
//    public void onLogin(UserId userName) {
//        rebuildSideBar();
//        refreshProjectList();
//        updateLoginDependentComponents();
//    }
//
//    @Override
//    public void onLogout(UserId userName) {
//        rebuildSideBar();
//        refreshProjectList();
//        updateLoginDependentComponents();
//    }
...
//            return projectOwner != null && projectOwner.equals(Application.get().getUserId().getUserName());
//        }
//
//        /**
//         * Gets the label of this thing.
...
//            boolean ownedByLoggedInUser = Application.get().isLoggedIn() && owner != null && owner.equals(Application.get().getUserId().getUserName());
...
//            boolean loggedIn = Application.get().isLoggedIn();
...
//                return;
//            }
//            String userName = Application.get().getUserId().getUserName();
