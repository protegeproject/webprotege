...
public class ProjectLayoutConfigurationBuilder {
    ...
    private List<Perspective> tabs;


    public ProjectLayoutConfigurationBuilder(ProjectId projectId, List<Perspective> tabs) {
...
//                tabConfiguration.setName(UserDefinedTab.class.getName());
    ...
    private List<PortletConfiguration> buildPortletConfigurations(Perspective tab, int columnIndex) {
