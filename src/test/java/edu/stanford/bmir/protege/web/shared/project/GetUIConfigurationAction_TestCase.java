...
public class GetUIConfigurationAction_TestCase {


    private GetUIConfigurationAction action;

    private GetUIConfigurationAction otherAction;
    ...
    public void setUp() throws Exception {
        action = new GetUIConfigurationAction(projectId);
        otherAction = new GetUIConfigurationAction(projectId);
    }

    @Test(expected = NullPointerException.class)
    public void shouldThrowNullPointerException() {
        new GetUIConfigurationAction(null);
    }
    ...
    public void shouldGenerateToString() {
        assertThat(action.toString(), startsWith("GetUIConfigurationAction"));
    }
